...
#   lh-report.sh v0.0.29           # reads site/lh/v0.0.29/*.run-1.report.json
...
SOURCE:
  ...
  v<tag>            site/lh/<tag>/*.run-1.report.json   (archived CI bundle)
...
elif [[ "$ARG" == v* ]];     then REPORT_DIR="site/lh/$ARG";  LABEL="$REPORT_DIR"
