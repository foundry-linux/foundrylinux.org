...
<span className="ember">curl</span> <span className="kw">-fsSL</span> <span className="str">https://apt.linuxfoundry.org/keyring.gpg</span> \
...
<span className="ember">echo</span> <span className="str">"deb [signed-by=/etc/apt/keyrings/foundry.gpg] \
  https://apt.linuxfoundry.org stable main"</span> \
