...
- [ ] **(triage)** [ ] Consider wiring the audit into CI as a guard on new `packages/*/` additions, so a future package — _from [2026-08-05-audit-upstream-packaging.md](docs/plans/2026-08-05-audit-upstream-packaging.md)_  <!-- fp:84965ee7547fc11c -->
- [ ] **(triage)** [ ] `x-emulators`: decide whether the binary-name divergence (`xc65` vs upstream `xemu-*`) is worth — _from [2026-08-05-audit-upstream-packaging.md](docs/plans/2026-08-05-audit-upstream-packaging.md)_  <!-- fp:01af3e36d5e672e1 -->
- [verify] **2026-08-05-audit-upstream-packaging** — Verification section present but no PASS recorded — run + record the steps. _from [2026-08-05-audit-upstream-packaging.md](docs/plans/2026-08-05-audit-upstream-packaging.md)_  <!-- fp:940e545bbb396414 -->
