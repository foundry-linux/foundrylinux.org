...
- [ ] **Delete 5 superseded draft plans** (the 2026-06-04 sweep found these are dead duplicates of the executed versions, never implemented as-written): `2026-05-17-per-metapackage-install-scripts-2.md` (old `worldfoundry-*` naming), `2026-05-17-upgrade-actions-node24.md` (dup of `-github-actions-node24`), `2026-05-18-lighthouse-ci-2.md` (dup of `lighthouse-ci`), `2026-05-18-version-deb-links-2.md` (dup of `version-deb-links`), `2026-05-28-enrich-generate-index-from-control.md` (superseded by the apt-package-meta two-script approach). All under `docs/plans/`.
