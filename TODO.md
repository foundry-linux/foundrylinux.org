...
- [x] **xemu — check the 8 targets the default build skips** — investigated 2026-08-06. Three compile but upstream explicitly labels each unusable/unfinished; five fail against removed APIs, missing symbols, or missing link objects. Package none; revisit only if upstream promotes a target into its root `TARGETS` list. See [plan](docs/plans/2026-08-05-xemu-rename-and-upstream-pr.md).
