...
- [ ] **f9dasm** ([plan](docs/plans/2026-05-18-package-f9dasm.md)) — 6800/6809/6309 disassembler ([github.com/Arakula/f9dasm](https://github.com/Arakula/f9dasm)). First test of the `/package` skill. `[verify]` pending.
