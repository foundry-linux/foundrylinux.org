...
| <span style="white-space:nowrap"><code>xemu</code></span> | [xemu-project/xemu](https://github.com/xemu-project/xemu) | [GPL-2.0](https://github.com/xemu-project/xemu/blob/master/LICENSE) (QEMU fork — individual files GPL-2+ / LGPL-2.1+ / BSD / MIT; the vendored meson subprojects are aggregated by upstream into `/usr/share/doc/xemu/LICENSE.upstream.txt`) | `/usr/share/doc/xemu/copyright` |
