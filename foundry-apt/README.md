...
Shared Electron runtimes and compatible desktop applications moved to the
independent [`sharedpair/shared-electron`](https://github.com/sharedpair/shared-electron)
repository on 31 August 2026.
...
reproducible merely because `task build` produced it in Docker.
