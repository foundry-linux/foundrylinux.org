...
3. Watch [the publish workflow](.github/workflows/publish.yml) — it builds, signs, syncs to R2, and smoke-checks `foundry-retro-tools` (and all other packages) in a clean Ubuntu 26.04 container.
