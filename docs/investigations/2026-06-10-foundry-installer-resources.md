...
### `banner.png` — 800×200 (`productWelcome`)

<img src="screenshots/branding-banner.png" width="760">

The Welcome-page header: "FOUNDRY LINUX" with the orange rule and "26.04 LTS · ANVIL".
...
- **Logo**: 256×256 square (anvil). **Banner**: 800×200 (4:1). **Backgrounds** (GRUB, Plymouth,
