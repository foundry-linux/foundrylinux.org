...
#
# Routes through the foundry-linux-android-development metapackage on
...
for arg in "$@"; do
    case "$arg" in
        -h|--help)
            cat <<EOF
Phase 0 installer for foundry-linux-android-development

Installs the foundry-linux-android-development metapackage from
...
step "Installing foundry-linux-android-development"
run_sudo apt-get install -y foundry-linux-android-development
ok "foundry-linux-android-development installed (JDK 17, adb, NDK r26c)"
